...
public class EditRegScreen extends BaseScreen implements ActionListener {
    ...
    private String[] user_fields_txt = { "Name", "Email", "Address", "New Password", "Confirm Password", "General" };
    ...
    public EditRegScreen(App application, BaseScreen screen) {
        ...
        for (int i = 0; i < user_info_fields.length; i++) {
            ...
            // from dataprovider
            user_info_fields[i].setBorder(new TitledBorder(BorderFactory.createTitledBorder(user_fields_txt[i])));
