...
public class DataProvider {
	...
	public ArrayList<Category> getAllCategories() {
		ArrayList<Category> categories = (ArrayList<Category>) this
				.getData(CATEGORYPATH);
		return categories;
	}
	...
	public ArrayList<Entry> getEntriesByCategoryId(String id) {
		...
		for (Entry e : allEntries) {
			if (e.getCategoryID() != null
					&& e.getCategoryID().compareTo(id) == 0) {
				resultList.add(e);
			}
		}
		return resultList;
	...
	public ArrayList<? extends BaseEntity> saveItem(BaseEntity item) {
		...
		@SuppressWarnings("unchecked")
		ArrayList<BaseEntity> data = (ArrayList<BaseEntity>) this
				.getData(filePath);
